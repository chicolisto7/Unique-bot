...
global.channelLink = "https://whatsapp.com/channel/0029Vb6ojLuAzNc32AUrdq0O";
global.ytch = "CHICOLISTO";
        ...
        if (isBanned(senderId) && !userMessage.startsWith('.unban')) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '🛑 UNIQUE BOT 𓃬: You’ve been officially blocked from commands. Talk to an admin.',
                    ...channelInfo
                });
            }
            return;
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (
                ...
                if (!isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, {
                        text: '😈 CHICOLISTO: Nice try, peasant. This button belongs to the kings and queens (admins).',
                        ...channelInfo
                    });
                    return;
                }
        ...
        switch (true) {
            case userMessage === '.simage': {
                ...
                if (quotedMessage?.stickerMessage) {
                    ...
                    await sock.sendMessage(chatId, { text: '🎯 Tip from UNIQUE BOT 𓃬: Just reply to any sticker with .simage and watch the magic happen ✨.', ...channelInfo });
                }
                break;
            }
            ...
            case userMessage.startsWith('.mute'):
                ...
                if (isNaN(muteDuration)) {
                    await sock.sendMessage(chatId, { text: '🕒 UNIQUE BOT 𓃬Tip: Minutes must be valid! Try: .mute 10\neg to mute 10 minutes\n.mute 10', ...channelInfo });
                } else {
...
case (userMessage && userMessage.trim().toLowerCase() === '.whoisgay'):
  ...
  break;
            ...
            case userMessage.startsWith('.mode'):
                ...
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `🔄 Mode updated — UNIQUE BOT 𓃬is now in *${action}* mode.`, ...channelInfo });
                } catch (error) {
  ...
  break;
            ...
            case userMessage.startsWith('.antilink'):
                if (!isGroup) {
                    await sock.sendMessage(chatId, {
                        text: '🏠 UNIQUE BOT 𓃬: This command works only inside groups.',
                        ...channelInfo
                    });
                    return;
                }
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: '⚠️ UNIQUE BOT 𓃬: Make me an admin first so I can do my magic. 🪄',
                        ...channelInfo
                    });
                    return;
                }
         ...
         // .explode
            ...
            case userMessage.startsWith('.weather'):
                ...
                if (city) {
                    ...
                    await sock.sendMessage(chatId, { text: '🌍 Tell me the city name, boss. Example: .weather Tanzania', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.move'):
                ...
                if (isNaN(position)) {
                    await sock.sendMessage(chatId, { text: '🕹 UNIQUE BOT 𓃬says: That’s not a valid position! Pick a real one.', ...channelInfo });
                } else {
  ...
  break;
            case userMessage.startsWith('.answer'):
                ...
                if (answer) {
                    ...
                    sock.sendMessage(chatId, { text: '💬 UNIQUE BOT 𓃬: Provide your answer using .answer <answer>', ...channelInfo });
                }
                break;
    ...
    break;
            ...
            case userMessage.startsWith('.welcome'):
                if (isGroup) {
                    ...
                    await sock.sendMessage(chatId, { text: '🏠 UNIQUE BOT 𓃬: This command can only be used inside groups...', ...channelInfo });
                }
                break;
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { text: '*👑 Give UNIQUE BOT 𓃬 admin powers before trying this!*', ...channelInfo });
                    return;
                }
            ...
            case userMessage.startsWith('.chatbot'):
                if (!isGroup) {
                    await sock.sendMessage(chatId, { text: '👥 UNIQUE BOT 𓃬 says: You gotta be in a group to run this..', ...channelInfo });
                    return;
                }
                ...
                if (!chatbotAdminStatus.isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, { text: '*🚫 UNIQUE BOT 𓃬: Only group admins or the bot owner can use this command. 👑*', ...channelInfo });
                    return;
                }
...
// Update commands for update bot auto 
     ...
     //           break;
            ...
            case userMessage === '.groupinfo' || userMessage === '.infogp' || userMessage === '.infogrupo':
                if (!isGroup) {
                    await sock.sendMessage(chatId, { text: '👥 UNIQUE BOT 𓃬 says: You must be in a group to use this.', ...channelInfo });
                    return;
                }
...
case userMessage.startsWith('.sudo'):
                ...
                async function groupJidCommand(sock, chatId, message) {
                    ...
                    if (!groupJid.endsWith('@g.us')) {
                        return await sock.sendMessage(chatId, {
                            text: "👥 UNIQUE BOT 𓃬 says: You must be in a group to use this."
                        });
                    }
        ...
        if (chatId) {
            await sock.sendMessage(chatId, {
                text: '💥 Error! UNIQUE BOT 𓃬 couldn’t complete your request.',
                ...channelInfo
            });
        }
    }
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const welcomeMessage = welcomeData?.message || '👑 UNIQUE BOT 𓃬: Hail {user}! The group just got cooler with you here!';
