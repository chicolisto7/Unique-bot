...
async function characterCommand(sock, chatId, message) {
    ...
    try {
        ...
        } catch {"https://i.ibb.co/qY6fv10H/me.jpg"'; // Default image if no profile pic
        }

        const traits = [
            "Minato", "Itachi", "Determined", "Ambitious", "Caring",
            "Charismatic", "Confident", "Empathetic", "Energetic", "Friendly",
            "Generous", "Honest", "Humorous", "Imaginative", "Independent",
            "Intuitive", "Naurto", "Logical", "Hinata", "Optimistic",
            "Shiro", "Patient", "Hokage", "Reliable", "Resourceful",
